...
for filename in preprocessed_images:
    ...
    psnr_value = psnr(input_image, denoised_image_cpu, data_range=1.0)
    ssim_value = ssim(input_image, denoised_image_cpu, data_range=1.0)
    print(f"Processed {filename}: PSNR = {psnr_value}, SSIM = {ssim_value}, CPU Time = {cpu_time} seconds")
